...
#define IOT_NAME				"ENV-SENSOR-GH"
#define PUBTOPIC				"esp/env-sensor-gh/set"
#define OUTTOPIC				"esp/env-sensor-gh"
...
void loop() {
	...
	uint32_t ah = getAbsoluteHumidity((float)t_event.temperature, (float)h_event.relative_humidity);
